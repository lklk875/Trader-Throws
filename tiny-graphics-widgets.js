...
{                                               // **Controls_Widget** adds an array of panels to the document, one per loaded
  ...
  constructor( element, scenes )
    { const rules = [ ".controls-widget * { font-family:  Geneva }",
                      ".controls-widget div { background: white; display: flex; justify-content: center;}",
                      ".controls-widget table { border-collapse: collapse; display:block; overflow-x: auto; }",
                      ".controls-widget table.control-box { width: 1080px; border:0; margin:0; max-height:130px; transition:.5s; overflow-y:scroll; background:white }",
                      ".controls-widget table.control-box:hover { max-height:130px }",
                      ".controls-widget table.control-box td { overflow:hidden; border:0; background:white;}",
                      ".controls-widget table.control-box td .control-div { background: #EEEEEE; width: 1080px; height:130px; padding: 5px 5px 5px 20px; box-shadow: 0px 0px 0px 0px inset }",
                      ...
                      ".controls-widget table.control-box .control-title { padding:10px 480px 10px; color:white; background:#FFCC66;  }",
                      ...
                      ".controls-widget button { width: 70px; height: 70px; margin: 4px; color: white; padding: 9px; border-radius:40px; \
                                                 transition: background .3s, transform .3s }",
                      ".controls-widget button:hover, button:focus { transform: scale(1.3); }",
    ...
    { this.timestamp = time;
      ...
      { open_list.push( ...open_list[0].children );
        ...
        control_box.appendChild( Object.assign( document.createElement("div"), { 
                                      textContent: "TRADER THROWS", className: "control-title" } ) )
